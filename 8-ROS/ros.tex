...
\only<1> {
    \begin{center}
    \input{8-ROS/sketches/scene-graph-only-cube.tex}
    \end{center}
}
\only<2-> {
    \begin{center}
    \input{8-ROS/sketches/scene-graph-cube.tex}
    \end{center}
}
...
\begin{shcode}
> cd imgproc
> mkdir -p src/imgproc && cd src/imgproc
...
\begin{shcode}
> rosrun imgproc reco image:=/usb_cam/image_raw
\end{shcode}
