    ...
    \begin{center}
        \resizebox{\linewidth}{!}{
            \begin{tikzpicture}[>=latex,
                ...
                \node[minimum width=2cm,align=center] at (0,0) (env) {\bf Environment};
                \node[draw,rotate=90,align=center,right=3 of env] (per) {Perceive};
                \node[draw,rotate=90,align=center,right=of per] (mod) {Model};
                \node[draw,rotate=90,align=center,right=of mod] (pla) {Plan};
                \node[draw,rotate=90,align=center,right=of pla] (act) {Act};
                \node[minimum width=2cm,align=center, right=3 of act] (env2) {\bf Environment};
