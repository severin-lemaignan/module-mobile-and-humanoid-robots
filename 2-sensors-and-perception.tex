...
\begin{frame}[plain]
    ...
    \begin{tikzpicture} 
        ...
        \draw[dotted,thick, grey] (3*pi * 0.2 ,0) -- (3*pi * 0.2, -5.2);
        \draw[dotted,thick, grey] (5*pi * 0.2 ,0) -- (5*pi * 0.2, -5.2);
        \draw[dotted,thick, grey] (13*pi * 0.2 ,0) -- (13*pi * 0.2, -5.2);
        \draw[dotted,thick, grey] (15*pi * 0.2 ,0) -- (15*pi * 0.2, -5.2);

        \draw[dotted,thick, grey] (10.1*pi * 0.2 ,-2.5*0.5) -- (10.1*pi * 0.2, -5.2);
...
\begin{frame}{Phase-shift measurement of TOF}
    ...
    \only<1>{
        ...
        Where \emph{c}: is the speed of light; \emph{f} the
