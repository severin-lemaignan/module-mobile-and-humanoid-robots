...
\begin{frame}{Structured light -- 1D illustration}
    ...
    \only<1>{
        \begin{columns}
            ...
            \begin{column}{0.5\linewidth}
                \begin{center}
                    \includegraphics[width=0.8\linewidth]{2d-structured-light-schematic}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \only<2>{
        ...
        \begin{exampleblock}{}
            For large  b, the chance that an illuminated point is not visible to the receiver increases
        \end{exampleblock}
