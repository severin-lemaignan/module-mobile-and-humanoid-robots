...
\begin{frame}{Correct step equations (measurement update)}
    ...
    \huge\centering
    $\mathbf{K}_{k\bubblemark[0pt]{up6}} = \mathbf{P}_{k\mid k-1}\cdot \mathbf{H}^{\text{T}}\cdot (\mathbf{H}\cdot \mathbf{P}_{k\mid k-1}\cdot \mathbf{H}^{\text{T}} + \bubblemark[0pt]{up8}\mathbf{R})$
        ...
        \only<6->{
            ...
            \begin{align*}
                z_k &= \mathbf{H}\cdot \colvec{y \\ \dot{y}}_{k-1\mid k-1} + \mathbf{w}_k \\
                    &= \begin{bmatrix}1 & 0 \\ 0 & 0\end{bmatrix} \cdot \begin{bmatrix}y \\ \dot{y}\end{bmatrix}_{k-1\mid k-1} + \mathbf{w}_k
            \end{align*}
