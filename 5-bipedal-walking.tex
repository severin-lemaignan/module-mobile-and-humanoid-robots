...
\begin{tabular}{p{2.6cm}p{2.6cm}p{2.6cm}p{2.6cm}}
    \video[1.2]{1.8cm}{figs/part5/walking_person.mp4} & 
    \includegraphics[height=2.2cm]{image7} & \includegraphics[height=2.2cm]{image8} & \\
    Walking person \emph{$\pm$5km/h} & WL-5 ('70) \emph{45s/step}  & E2 ('91) \emph{1.2km/h} & \\
 \includegraphics[height=2.2cm]{nao-robocup} & \includegraphics[height=2.2cm]{image6} & \includegraphics[height=2.2cm]{image11} & \includegraphics[height=2.2cm]{image10} \\
...
\begin{frame}{Effort to lift foot 1cm?}
    ...
    \begin{center}
        \resizebox{\linewidth}{!}{%
        \begin{tikzpicture}
            \node at (0,0) {\includegraphics[width=12cm]{graph3}};
...
\begin{frame}{Force and moment on a body}
        ...
        Resultant force of inertia and gravity forces is:

            $F^{gi} =\bubblemark[0pt]{eq1} m\cdot g - m\cdot a_G$

            \vspace{5em}
        \href{http://en.wikipedia.org/wiki/Moment_of_force}{Moment} (aka
            torque) in any point $X$ is:

            $M^{gi}_X =\bubblemark[0pt]{eq2} \vec{XG} \times m\cdot g - \vec{XG} \times m\cdot a_G - \dot{H}_G$
...
\begin{frame}{Force and moment because of contact}
        ...
        Resultant contact forces:
            ...
            $F^{C} + m\cdot g\bubblemark[0pt]{eq3} = m\cdot a_G$

            \vspace{5em}

        Moment caused by contact forces:

            $M_X^C + \vec{XG} \times m\cdot g =\bubblemark[0pt]{eq4} \dot{H}_G + \vec{XG} \times m\cdot a_G$
...
\begin{frame}{Dynamical balance}
    ...
    \bubble<1>[90][0.5][7cm]{eq6}{$n$ is normal vector (a vector perpendicular to a surface of length 1) to the support surface. $Z$ is the Zero Moment Point, $P$ is the resultant point of contact of the foot.}
